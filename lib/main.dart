import 'package:flutter/material.dart'; //sets up the Flutter app
import 'package:firebase_core/firebase_core.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'screens/welcome_screen.dart'; //imports welcome screen
import 'screens/onboarding_screen.dart';
import 'screens/auth_screen.dart';
import 'screens/home_screen.dart';
import 'widgets/appentry.dart';

//main() is the entry point of every dart app
//runapp() starts the app with your custom widget MyApp
void main() async{
  ...
  await prefs.setString('uid', 'your_uid_here'); // Replace with actual UID from login
  final uid = prefs.getString('uid');
  print('Stored UID: $uid');
  
  runApp(SmartSavingsApp());
}
